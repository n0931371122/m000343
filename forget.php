        ...
        <main>
            <div class="position-relative overflow-hidden" style="background-image:url(styles/images/member/register/register-bg.jpg)">
                ...
                <div class="section flex-center px-3 px-md-4">
                    <div class="max520 bg-white rounded-15 mb-5 mb-md-0 py-4 px-3 px-md-4" data-aos="fade-up">
                        <div class="px-md-2 pt-1 pb-3">
                            <div class="text-center">
                                <img src="styles/images/member/register/lock.png" alt="">
                                <h1 class="fz-28 fw-bold text-primary les2 mt-3 mb-3 pb-md-1">忘記密碼</h1>
                                <p class="les1 mb-0 mb-4 pb-md-2">請輸入您註冊時的 E-mail 帳號，系統將會自動寄送一組網址至您的信箱，點選網址後即可進入進行修改。</p>
                            </div>
                            <form class="px-md-5" action="forget-ok">
