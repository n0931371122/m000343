                    ...
                    <div class="pt-3 mb-md-3 mb-xl-5 pb-4">
                        <div class="links-element max600" data-aos="fade-up">
                            ...
                            <div class="links row g-0">
                                <a class="d-block col-12 col-md active" href="lecturer">訂單查詢</a>
                                <a class="d-block col-12 col-md" href="lecturer-profit">分潤資訊</a>
                                <a class="d-block col-12 col-md" href="lecturer-discussion">課程討論紀錄</a>
                            </div>
                        </div>
                    </div>
                    <div class="bg-white box-shadow rounded-15 lh-18 py-4 px-3 px-md-4 mb-4" data-aos="fade-up">
                        <div class="px-xl-2 py-md-2 mx-xl-1">
                            <div class="title-box d-md-flex justify-content-between align-items-end ms-xl-2 mb-md-3 mb-lg-4 pb-lg-1">
                                <h3 class="title-dec-line position-relative fz-22 fw-bold les1 ps-3 mb-3 mb-md-0">訂單查詢</h3>
                            ...
                            <div class="content-box pt-4 pt-md-0">
                                <div class="listsItem">
                                    <div class="thead d-none d-lg-flex row align-items-center g-0 fz-18 bg-grayF8 h60 rounded-15 px-3 mb-3">
                                        <div class="info th col flex-grow-1">課程資訊</div>
                                        <div class="dividendAmount th col text-center">分潤金額</div>
                                        <div class="orderStatus th col text-center">訂單狀態</div>
                                    </div>
                                    <div class="tbody px-lg-3">
                                        <div class="tr listItem border-bottom-E5E5E5 mb-3" data-aos="fade-up">
                                            ...
                                            <div class="main-box d-block d-lg-flex row g-0 align-items-center">
                                                <div class="info td col flex-grow-1">
                                                    <a class="item d-block d-xl-flex align-items-center pe-xl-0" href="course-1">
                                                        ...
                                                        <span class="text-inner d-block les1">
                                                            <span class="title fz-18 fw-500 text-hover-primary line2 lh-sm">了解主力操作個股的思維與揣測未來可能的走勢與方向 </span>
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="dividendAmount td text-lg-center" data-th="分潤金額">
                                                    <span class="fz-20">$ 9,880</span>
                                                </div>
                                                <div class="orderStatus td text-lg-center" data-th="訂單狀態">
