            ...
            <div class="pb-element bg-paleBlue">
                <div class="bg-white px-3 px-md-4 pb-5">
                    <div class="max1400 mx-auto pt-4 pb-xl-5">
                        ...
                        <form class="form" action="cart-project-2">
                                    ...
                                    <div class="col-12 col-lg-8 col-xl-9 pe-lg-4 mb-3 mb-md-4 mb-lg-0" data-aos="fade-up">
                                        <div class="me-xxl-2">
                                                    ...
                                                    <div class="py-md-3 px-xl-2 mx-xl-1">
                                                        ...
                                                        <div class="content-box pb-2 px-xl-2 pt-3">
                                                            ...
                                                            <div class="form-field flex-grow-1 d-sm-flex align-items-center mb-3">
                                                                <label class="d-block mb-1 mb-sm-0" for="mail">電子信箱<span class="text-red ms-2">*</span></label>
                                                                <input class="flex-grow-1 w-100 border border-grayE5 rounded-10 px-3 py-2" type="email" name="mail" id="mail" placeholder="test@gmail.com">
                                                            </div>
                                                            <div class="form-field flex-grow-1 d-sm-flex align-items-center mb-3">
                                            ...
                                            <div class="mb-4 pb-1">
                                                <div class="bg-white box-shadow rounded-15 lh-18 py-4 px-3 px-md-4">
                                                    <div class="py-md-3 px-xl-2 mx-xl-1">
                                                        <div class="title-box d-md-flex ms-xl-2 mb-3">
                                                            <h3 class="title-dec-line flex-shrink-0 position-relative fz-22 fw-bold les1 ps-3 mb-0">付款方式</h3>
                                                            <p class="text-gray80 ms-md-4 mb-0 mt-2 mt-md-0">交易系統導入SSL 256bit 加密機制，保護買賣雙方資料安全</p>
                                                        </div>
                                                        <div class="content-box px-xl-2 pt-2">
                                                            <div class="border-bottom-E5E5E5 pb-4">
                                                                <div class="nav nav-tabs border-0 pb-1">
                                                                    <button class="text-primary border border-primary rounded-30 w150 py-2 me-3 active" type="button" data-bs-toggle="tab" data-bs-target="#creditCard">信用卡付款</button>
                                                                </div>
                                                            </div>
                                                            <div class="tab-content pt-3">
                                                                <div class="tab-pane fade show active" id="creditCard">
                                                                    <span class="d-block fz-18 fw-bold mt-1">免費試閱</span>
                                                                    <ul class="ns text-gray80 pt-1">
                                                                        <li>試閱到期日：2021-08-30 20:39</li>
                                                                        <li>本次扣款金額：NT$0</li>
                                                                        <li>下次扣款日：2021-08-31</li>
                                                                        <li>下次扣款金額：NT$199 </li>
                                                                    </ul>
                                                                    <span class="d-block fz-18 fw-bold mt-4 pt-1">請注意：</span>
                                                                    <ul class="ns yellow-dots small-dot text-gray80 pt-1">
                                                                        <li>免費試閱需綁定信用卡，<span class="text-lightRed">系統會在試閱到期日隔天自動扣緩並續訂</span></li>
                                                                        <li>試閱到期日<span class="text-lightRed">前一天</span>將以 E-mail 提醒相關事宜</li>
                                                                        <li>若不繼續使用，請務必在試閱到期日前至「訂單管理」取消試閱</li>
                                                                        <li>
                                                                            <div class="d-md-flex align-items-center">
                                                                                <p class="me-md-3 mb-2 mb-md-0">簽帳金融卡JCB、VISA、Mastercard 也可以付費。</p>
                                                                                <img style="width:100px" src="styles/images/cart/creditCard.jpg" alt="">
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                ...
                                                <div class="bg-white box-shadow rounded-15 lh-18 py-4 px-3 px-md-4">
                                                    <div class="py-md-3 px-xl-2 mx-xl-1">
                                                        ...
                                                        <div class="content-box px-xl-2 pt-2">
                                                            <div class="border-bottom-E5E5E5 pb-4">
                                                                <div class="nav nav-tabs border-0 pb-1">
                                                                    <button class="text-primary border border-primary rounded-30 w150 py-2 me-3 active" type="button" data-bs-toggle="tab" data-bs-target="#personalInvoice">個人電子發票</button>
                                                    ...
                                                    <div class="border-bottom-E5E5E5 py-3">
                                                        <div class="my-md-1">
                                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                                ...
                                                                <span class="fz-20 fw-bold">NT$ 199</span>
                                                            </div>
                                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                    ...
                                                    <div class="border-bottom-E5E5E5 py-2">
                                                        <div class="my-md-1">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <span class="fz-28 fw-bold text-lightRed">NT$ 0</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex row g-2 mt-4 pt-1">
                                                        <div class="col-5">
                                                            <a class="flex-center border border-primary text-primary text-hover-white bg-white bg-hover-middleBlue rounded-30 h50" href="course-1">返回</a>
                                                        </div>
                                                        <div class="col-7 ps-2">
                                                            <button class="text-white bg-primary bg-hover-middleBlue rounded-30 text-center h50 w-100 px-3" type="submit">進行付款</button>
                                                        </div>
                                                    </div>
