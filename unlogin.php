...
<body>
    <div class="wp">
        ...
        <!-- main ======================================================================================= -->
        <main>
            <div class="pb-element px-3 px-md-4" style="background-image: url(styles/images/contact/privacy-bg.jpg);">
                    ...
                    <div class="pt-3 mb-md-3 mb-xl-4 pb-4">
                        <div class="links-element max600" data-aos="fade-up">
                            ...
                            <div class="links row g-0">
                                <a class="d-block col-12 col-md" href="contact">聯絡客服</a>
                                <a class="d-block col-12 col-md active" href="privacy">隱私權政策</a>
                                <a class="d-block col-12 col-md" href="terms">使用者條款</a>
                            </div>
                        </div>
                    </div>
                    <div class="pt-2">
                        <div class="bg-white rounded-25 lh-18 px-3 px-md-4 pt-4 pb-2 py-md-5 p-xl-5">
                            <div class="px-xl-3 pt-xl-2">
                                <h2 class="fz-28 fw-500 border-bottom-E5E5E5 pb-3 pb-md-4 mb-0 mb-md-2" data-aos="fade-up">隱私權政策</h2>
                                <div class="border-bottom-E5E5E5 pt-4 pb-md-3">
                                    <p class="text-gray80" data-aos="fade-up">非常歡迎您光臨「熊課線上學習網」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請詳閱下列內容：</p>
                                </div>
                                <div class="mt-4 pt-md-2">
                                    <ul class="ns">
                                        <li class="pb-3">
                                            <h3 class="fz-22 fw-500 text-primary mb-2 mb-md-3" data-aos="fade-up">一、隱私權保護政策的適用範圍</h3>
                                            <div class="text-gray80" data-aos="fade-up">
                                                <p>隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。</p>
                                            </div>
                                        </li>
                                        <li class="pb-3">
                                            <h3 class="fz-22 fw-500 text-primary mb-2 mb-md-3" data-aos="fade-up">二、個人資料的蒐集、處理及利用方式</h3>
                                            <div class="text-gray80" data-aos="fade-up">
                                                <ul class="ns yellow-dots mb-3">
                                        ...
                                        <li class="pb-3">
                                            <h3 class="fz-22 fw-500 text-primary mb-2 mb-md-3" data-aos="fade-up">三、資料之保護</h3>
                                            <div class="text-gray80" data-aos="fade-up">
                                                <ul class="ns yellow-dots mb-3">
                                        ...
                                        <li class="pb-3">
                                            <h3 class="fz-22 fw-500 text-primary mb-2 mb-md-3" data-aos="fade-up">四、網站對外的相關連結</h3>
                                            <div class="text-gray80" data-aos="fade-up">
                                                <p>本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。</p>
                                            </div>
                                        </li>
                                        <li class="pb-3">
                                            <h3 class="fz-22 fw-500 text-primary mb-2 mb-md-3" data-aos="fade-up">五、與第三人共用個人資料之政策</h3>
                                            <div class="text-gray80" data-aos="fade-up">
                                                ...
                                                <ul class="ns yellow-dots mb-3">
                                                    ...
                                                    <li>當您在網站的行為，違反服務條款或可能損害或妨礙網站與其他使用者權益或導致任何人遭受損害時，經網站管理單位研析揭露您的個人資料是為了辨識、聯絡或採取法律</li>
                                                    <li>行動所必要者。</li>
                                                    <li>有利於您的權益。</li>
                                        ...
                                        <li class="pb-3">
                                            <h3 class="fz-22 fw-500 text-primary mb-2 mb-md-3" data-aos="fade-up">六、Cookie之使用</h3>
                                            <div class="text-gray80" data-aos="fade-up">
                                                <p>為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導至網站某些功能無法正常執行 。</p>
                                            </div>
                                        </li>
                                        <li class="pb-3">
                                            <h3 class="fz-22 fw-500 text-primary mb-2 mb-md-3" data-aos="fade-up">七、隱私權保護政策之修正</h3>
                                            <div class="text-gray80" data-aos="fade-up">
